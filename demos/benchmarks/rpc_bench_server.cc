...
// RPC-over-QUIC benchmark server.
//
// Exposes three verbs over the seastar RPC protocol running on the QUIC
// transport (same adapter used by the RPC QUIC demo):
//
...
// ---------------------------------------------------------------------------
// Minimal serializer -- matches the RPC benchmark clients.
// ---------------------------------------------------------------------------
